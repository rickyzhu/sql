...
col module format A40 word_wrap
...
prompt Library Cache Locks are global locks in range [LA]-[LZ]
prompt Library Cache Pins are global locks in range [NA]-[NZ]
select inst_id, handle, grant_level, request_level, resource_name1, resource_name2,
pid , transaction_id0, transaction_id1 ,owner_node, blocked, blocker, state
